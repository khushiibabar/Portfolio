              ...
              <div className="relative flex flex-col items-center justify-center w-full h-full p-4 sm:p-8 md:p-12">
                ...
                >
                  <img
                    src={project.imageSrc}
                    alt={project.title}
                    className="object-cover max-w-full max-h-full transition-transform duration-300 rounded-2xl project-image hover:scale-105"
                  />
                </a>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="z-50 flex items-center gap-3 mt-6 text-sm text-black transition-colors duration-300 cursor-pointer project-title md:text-3xl md:font-bold text-nowrap hover:text-gray-400"
                >
                  {project.title} <SlShareAlt />
                </a>
              </div>
